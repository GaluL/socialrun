...
namespace socialrun
{
    public sealed partial class MainPage : Page
    {
        ...
        private async void SingalR()
        {
            conn = new HubConnection("http://socialrun.azurewebsites.net");
            proxy = conn.CreateHubProxy("ChatHub");

            await conn.Start();

            proxy.On<string>("broadcastMessage", OnMessage);

            await proxy.Invoke("Register", "Gal");
