#pragma checksum "C:\Users\galkl\Desktop\SocialRun\socialrun\Common\QuickStartTask.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "803346FE26AFCB67D93512995A9CC5A4"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace socialrun
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        {
            private global::socialrun.QuickStartTask dataRoot;
            ...
            public void SetDataRoot(global::socialrun.QuickStartTask newDataRoot)
            {
                this.bindingsTracking.ReleaseAllListeners();
            ...
            private void Update_(global::socialrun.QuickStartTask obj, int phase)
            {
            ...
            private class QuickStartTask_obj1_BindingsTracking
            {
                ...
                public void DependencyPropertyChanged_Title(global::Windows.UI.Xaml.DependencyObject sender, global::Windows.UI.Xaml.DependencyProperty prop)
                {
                    ...
                    {
                        global::socialrun.QuickStartTask obj = sender as global::socialrun.QuickStartTask;
        if (obj != null)
        {
        ...
        if (obj != null)
        {
            bindings.Update_Number(obj.Number, DATA_CHANGED);
                ...
                public void UpdateChildListeners_(global::socialrun.QuickStartTask obj)
                {
                    QuickStartTask_obj1_Bindings bindings;
                    if(WeakRefToBindingObj.TryGetTarget(out bindings))
                    {
                        ...
                        {
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::socialrun.QuickStartTask.TitleProperty, tokenDPC_Title);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::socialrun.QuickStartTask.DescriptionProperty, tokenDPC_Description);
                            bindings.dataRoot.UnregisterPropertyChangedCallback(global::socialrun.QuickStartTask.NumberProperty, tokenDPC_Number);
                        }
                        if (obj != null)
                        {
                            bindings.dataRoot = obj;
                            tokenDPC_Title = obj.RegisterPropertyChangedCallback(global::socialrun.QuickStartTask.TitleProperty, DependencyPropertyChanged_Title);
                            tokenDPC_Description = obj.RegisterPropertyChangedCallback(global::socialrun.QuickStartTask.DescriptionProperty, DependencyPropertyChanged_Description);
                            tokenDPC_Number = obj.RegisterPropertyChangedCallback(global::socialrun.QuickStartTask.NumberProperty, DependencyPropertyChanged_Number);
                        }
                    }
                }
            }
